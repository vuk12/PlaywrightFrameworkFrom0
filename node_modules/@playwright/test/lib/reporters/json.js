...
class JSONReporter {
  ...
  _serializeTestResult(result, file) {
    var _result$error;
    ...
    if ((_result$error = result.error) !== null && _result$error !== void 0 && _result$error.stack) {
      const {
        position
      } = (0, _base.prepareErrorStack)(result.error.stack, file);
      if (position) jsonResult.errorLocation = position;
    }
