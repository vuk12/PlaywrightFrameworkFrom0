...
function compareBuffersOrStrings(actualBuffer, expectedBuffer, mimeType) {
...
function compare(actual, pathSegments, snapshotPath, outputPath, updateSnapshots, withNegateComparison, options) {
  ...
  if (!_fs.default.existsSync(snapshotFile)) {
    ...
    if (isWriteMissingMode) {
      ...
      _fs.default.mkdirSync(_path.default.dirname(actualPath), {
        recursive: true
      });
  ...
  _fs.default.mkdirSync(_path.default.dirname(expectedPath), {
    recursive: true
  });
